...
| 6 | Never modify SDD artifacts (tasks.md exception for test-contract-correction) | Step 3c, Step 3g |
...
| 12 | Do-not-invent-entities: test-with-AC-trace vs test-orphan decision tree | Step 3c |
| 13 | Mid-flight decision log: write decisions[] BEFORE any out-of-plan fix | Step 3g |
