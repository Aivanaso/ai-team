...
This route tracks no phase state and archives nothing — there is no state machine, no change directory, no phase tracking (see `orchestrator-protocol.md` → "Organic Delegation Route"). What a project accumulates under `.ai-team/` is:
