...
5. Read `skills/_shared/evidence-protocol.md` — interface changes require implementors sweep; Rule 5 also applies if any task copies a pattern from a sibling repo
